...
def example1(manatees):
    ...
    #Since we're given that manatees has n elements, our code will take approximately
    #O(n) time to run.
...
def example3(manatees):
    #There are two for loops, and nested for loops are a good sign that you need
    #to multiply two runtimes. Here, for every manatee, we check every property.
...
manatees=[{'name': "Sem", 'age': 33}, {'name': "Tor", 'age': 33}, {'name': "Nas", 'age': 7}, {'name': "Aln", 'age': 4}]
print example3(manatees)
